...
import movieAppImage from "../imgs/project-images/movie-app.PNG";
  ...
  const projects = [
    {
      ...
      image: upartsImage,
      description:
        "Using HTML, CSS and Javascript to create a online store selling computer hardware.",
    ...
    },
    {
      ...
      image: imagepalImage,
      description:
        "Imagepal is a forum where people use images to communicate." +
    ...
    },
    {
      ...
      image: movieAppImage,
      description:
        "Built with Html, CSS and Javascript to access the third party TMDB API to display popular, top rated, upcomming, currently in theatre movies. There is also a search functionality which allows users to look for movies.",
      webLink: "https://alsonz.github.io/movie-app/",
      githubLink: "https://github.com/AlsonZ/movie-app",
    },
    {
      title: "Portfolio",
      image: portfolioImage,
      description:
        "My portfolio to display what I have learnt and the projects I have created.",
    ...
    },
    {
      ...
      image: todolistImage,
      description:
        "A Fullstack Todolist website with login, REST and CRUD operations.",
    ...
    },
    {
      ...
      image: chatroomImage,
      description:
        "A chatroom created with socket.io along with a room joining link similar to discord.",
    ...
    },
    {
      ...
      description:
        "Showing Weather information for Sydney by web scraping 3 sites.",
    ...
    },
    {
      ...
      description:
        "Using the https://exchangeratesapi.io/ API to get the most recent exchange rates.",
    ...
    },
    {
      ...
      description:
        "Using React Beautiful dnd library to creat drag and drop columns and items.",
